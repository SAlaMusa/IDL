...
echo "==> Pretraining pair_jitter_grayscale seed=$SEED"
...
cp linear_eval_results.csv results/confirmatory/pair_jitter_grayscale_seed${SEED}.csv
echo "==> Done. Saved results/confirmatory/pair_jitter_grayscale_seed${SEED}.csv"
