...
echo "==> Pretraining baseline CIFAR-10 seed=$SEED"
...
cp linear_eval_results.csv results/confirmatory/baseline_cifar10_seed${SEED}.csv
echo "==> Done. Saved results/confirmatory/baseline_cifar10_seed${SEED}.csv"
