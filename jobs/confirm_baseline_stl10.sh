...
echo "==> Pretraining baseline STL-10 seed=$SEED"
...
cp linear_eval_results.csv results/confirmatory/baseline_stl10_seed${SEED}.csv
echo "==> Done. Saved results/confirmatory/baseline_stl10_seed${SEED}.csv"
